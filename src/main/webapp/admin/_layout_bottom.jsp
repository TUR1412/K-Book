...
<div class="page-loading" id="page-loading" role="status" aria-live="polite" aria-hidden="true">
...
<div class="help-panel" id="shortcut-panel" aria-hidden="true" role="dialog" aria-modal="true" aria-labelledby="shortcut-title">
    <div class="help-card">
        <div>
            ...
            <p class="card-subtitle">用键盘完成常见操作，让借阅流程更顺手。</p>
        </div>
        <ul class="help-list">
            <li><span>新增图书</span><span><span class="kbd">Alt</span> + <span class="kbd">N</span></span></li>
        ...
        <div class="help-actions">
            <button class="btn btn-primary btn-sm" type="button" data-help-close>知道了</button>
        </div>
    </div>
</div>
</body>
